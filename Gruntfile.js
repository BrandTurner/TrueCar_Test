...
//            }
        ...
        jst: {
            compile: {
                options: {
                    ...
                    namespace: 'TrueCarTest.Templates'
                },
                files: {
    ...
    grunt.registerTask('createDefaultTemplate', function () {
        grunt.file.write('app/scripts/tmp/templates.js', 'window.TrueCarTest = window.TrueCarTest || {}; window.TrueCarTest.Templates = window.TrueCarTest.Templates || {};');
    });
